...
import multichannelImg from "@/public/i5.jpg";
...
const Sms: React.FC = () => {
  ...
  const services = [
    { 
      icon: <Image src={smsIcon} alt="Bulk SMS" width={80} height={80} />, 
      title: "Bulk SMS", 
      description: "Send thousands of messages instantly — branded, scheduled, and trackable." 
    },
    { 
      icon: <Image src={ussdIcon} alt="USSD" width={100} height={100} />, 
      title: "USSD Services", 
      description: "Launch interactive mobile services in minutes with short code extensions." 
    },
    { 
      icon: <Image src={otpIcon} alt="OTP" width={80} height={80} />, 
      title: "Email Campaigns", 
      description: "Automate email communications alongside your SMS and USSD flows." 
    },
    { 
      icon: <Image src={apiIcon} alt="API" width={80} height={80} />, 
      title: "Developer APIs", 
      description: "Plug into your systems via simple, well-documented REST APIs." 
    },
  ];
  ...
  const features = [
    { 
      title: "Connect", 
      description: "A unified platform for Bulk SMS, USSD, Email & Payments - all from one simple dashboard.", 
      image: communicateImg 
    },
    { 
      title: "Engage", 
      description: "Transform communication with interactive messaging and real-time customer engagement.", 
      image: engageImg 
    },
    { 
      title: "Transact", 
      description: "Accept mobile money, wallet payments and more with FalconPay integration.", 
      image: multichannelImg 
    },
    { 
      title: "Scale", 
      description: "Secure, scalable, and Ghana-ready platform designed for telecom and fintech ecosystems.", 
      image: integrateImg 
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <header className={`fixed top-0 w-full z-50 bg-white transition-all duration-300 ${isScrolled ? "shadow-lg py-1" : "shadow-sm py-2"} text-white`}>
        <div className="bg-[#2c73d2] py-2 px-4 text-white">
          <div className="max-w-7xl mx-auto flex justify-between items-center text-xs">
            <div className="flex items-center gap-3">
              ...
              <a href="mailto:info@falconconnect.com" className="hidden sm:inline font-bold hover:text-gray-200 transition text-xs">info@falconconnect.com</a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center h-16 text-white">
            <Link href="/" className="flex items-center">
              <Image src="/lg2.png" alt="FalconConnect Logo" width={120} height={45} className="object-contain" />
            </Link>
              ...
              {navItems.map((item, i) => (
                <Link
                  ...
                  className={`text-sm font-medium uppercase tracking-wide transition-colors ${
                    pathname === item.path 
                      ? "text-[#2c73d2] font-bold" 
                      : "text-gray-700 hover:text-[#2c73d2]"
                  }`}
                >
                  {item.name}
                </Link>
            ...
            <div className="hidden md:flex items-center gap-3">
              <a href="https://falconconnect.com/login" target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-[#2c73d2] !text-white font-bold rounded-md hover:opacity-90 uppercase transition text-sm">Log in</a>
              <a href="https://falconconnect.com/enquiry" target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-[#2c73d2] !text-white font-bold rounded-md hover:opacity-90 uppercase transition text-sm">ENQUIRY</a>
            </div>
            <button 
          ...
          <div className="px-4 py-4 space-y-3 text-black">
            {navItems.map((item, i) => (
              <Link 
                key={i} 
                href={item.path}
                className={`block px-4 py-3 rounded-lg text-base font-medium transition-colors border-b border-gray-100 ${
                  pathname === item.path
            ...
            <div className="pt-4 space-y-3 border-t border-gray-200">
              <a 
                href="https://falconconnect.com/login" 
                target="_blank" 
              ...
              <a 
                href="https://falconconnect.com/enquiry" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="block w-full px-4 py-3 text-center bg-gray-100 text-black rounded-lg hover:bg-gray-200 transition-colors text-base font-medium"
                onClick={() => setMobileMenuOpen(false)}
      ...
      <section className="relative w-full pt-20 sm:pt-28 md:pt-32 h-[80vh] sm:h-[70vh] md:h-[75vh] overflow-hidden">
        ...
        <div className="relative z-10 w-full h-full flex flex-col justify-center items-center text-center px-4 sm:px-6 text-white">
          ...
          >
            <TypingText text="Connect, Engage and Transact — all from one simple dashboard." speed={150} />
          </motion.p>
          
          <motion.div 
            initial={{ opacity: 0, y: 50 }} 
            animate={controls} 
            variants={{ hidden: { opacity: 0, y: 50 }, visible: { opacity: 1, y: 0, transition: { duration: 3.5, delay: 1.7, ease: "easeOut" } } }} 
          ...
          >
            ...
            <Link 
              ...
              className="px-6 py-3 border-2 border-white bg-white text-black rounded-md hover:text-blue-600 hover:bg-white uppercase font-bold tracking-wide transition-colors duration-300 !text-black text-center"
            >
              Contact Sales
            </Link>
          </motion.div>
      ...
      <section id="services" className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 bg-[#f8fff8] text-black">
        <div className="max-w-7xl mx-auto text-center mb-8 sm:mb-12 md:mb-16">
          ...
          <div className="w-16 sm:w-20 h-1 bg-[#2c73d2] mx-auto mb-4 sm:mb-6"></div>
          <p className="text-gray-600 max-w-3xl mx-auto text-sm sm:text-base md:text-lg leading-relaxed px-4">
            Whether you're a tech-savvy startup, an SME, or a growing fintech, FalconConnect offers comprehensive solutions to power your communication needs.
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 max-w-7xl mx-auto">
          {services.map((s,i)=>(
            <div key={i} className="group p-4 sm:p-6 md:p-8 bg-[#f8fff8] rounded-xl border-2 border-[#2c73d2]/30 hover:border-[#2c73d2] hover:shadow-2xl transition-all duration-300 text-center">
              ...
              <Link 
                href="/sections/Solutions" 
                className="text-[#00C853] font-semibold text-xs sm:text-sm uppercase tracking-wide hover:text-[#00b849] cursor-pointer transition-colors"
              >
                Learn More →
              </Link>
            </div>
          ...
          {features.map((f,i)=>(
            <div key={i} className={`flex flex-col ${i%2===1?"lg:flex-row-reverse":"lg:flex-row"} items-center gap-6 sm:gap-8 md:gap-10 lg:gap-16`}>
              ...
              >
                ...
                <div className="w-12 sm:w-16 h-1 bg-[#2c73d2] mb-4 sm:mb-6 mx-auto lg:mx-0"></div>
                <p className="text-gray-600 mb-4 sm:mb-6 md:mb-8 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed px-4 sm:px-0">
                  {f.description}
                </p>
                <Link 
                  href="/sections/Solutions"
                  className="px-6 sm:px-8 py-2 sm:py-3 bg-[#2c73d2] !text-white rounded-lg hover:bg-[#2c73d2] transition-colors text-xs sm:text-sm font-medium uppercase tracking-wide cursor-pointer shadow-lg mx-auto lg:mx-0 block text-center"
                >
                  Discover More
                </Link>
              </motion.div>
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 bg-white text-black">
        <div className="max-w-7xl mx-auto text-center mb-8 sm:mb-12 md:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-4 uppercase tracking-wide">
            Who is FalconConnect for?
          </h2>
          <div className="w-16 sm:w-20 h-1 bg-[#2c73d2] mx-auto mb-4 sm:mb-6"></div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 max-w-7xl mx-auto">
          {[
            { title: "Developers", description: "Integrate communications into your apps in minutes with our simple APIs." },
            { title: "SMEs & Retailers", description: "Send offers, updates, and invoices with ease through multiple channels." },
            { title: "Microbusinesses", description: "Reach customers via mobile — no internet required with USSD services." },
            { title: "NGOs & Campaigns", description: "Use USSD and SMS for outreach, surveys, and community engagement." }
          ].map((item, index) => (
            <div key={index} className="p-6 sm:p-8 bg-gray-50 rounded-xl border border-gray-200 hover:border-[#2c73d2] hover:shadow-xl transition-all duration-300 text-center">
              <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-gray-800 uppercase tracking-wide">
                {item.title}
              </h3>
      ...
      {/* SECURITY & SCALABILITY - Mobile Optimized */}
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 bg-gradient-to-br from-[#2c73d2] to-[#0089ba] text-white text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 uppercase tracking-wide">
            Secure. Scalable. Ghana-Ready.
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-12">
            {[
              "Licensed by the NCA with official short codes",
              "Hosted securely with telecom-grade uptime",
              "Designed for the Ghanaian telecom and fintech ecosystem"
            ].map((feature, index) => (
          ...
          <p className="text-green-100 text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 font-semibold">
            FalconConnect Mobile App
          </p>
          <p className="text-green-100 mb-6 sm:mb-8 max-w-2xl mx-auto text-sm sm:text-base md:text-lg leading-relaxed">
            Manage your business messaging and payments on the go — right from your phone.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 bg-white text-black">
        <div className="max-w-7xl mx-auto text-center mb-8 sm:mb-12 md:mb-16">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto text-sm sm:text-base md:text-lg px-4">
            See what our valued clients have to say about FalconConnect
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-7xl mx-auto mb-12 sm:mb-16 md:mb-20">
          {testimonials.map((t,i)=>(
            <div key={i} className="p-4 sm:p-6 cursor-pointer md:p-8 bg-gray-50 rounded-xl border border-gray-200 hover:border-[#2c73d2] hover:shadow-xl transition-all duration-300">
              <div className="flex mb-3 sm:mb-4 justify-center sm:justify-start">
                {[...Array(5)].map((_,idx)=>(
                  <Star key={idx} className={`w-4 h-4 sm:w-5 sm:h-5 ${idx<t.rating?"text-yellow-400 fill-[#2c73d2]":"text-gray-300"}`} />
                ))}
              </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 bg-gradient-to-br from-[#2c73d2] to-[#0089ba] text-center text-white">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-green-100 mb-6 sm:mb-8 md:mb-10 max-w-2xl mx-auto text-sm sm:text-base md:text-lg leading-relaxed px-4">
            Start sending messages, collecting payments, and building mobile services with FalconConnect.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 max-w-md mx-auto px-4">
            <Link 
              href="/sections/Products"
              className="px-6 sm:px-8 md:px-10 py-3 sm:py-4 border-2 border-white cursor-pointer text-white rounded-lg hover:bg-[#2c73d2] hover:text-white transition-all duration-300 text-sm sm:text-base font-bold uppercase tracking-wide text-center"
            >
              Create Account
            </Link>
            {/* <Link 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8 md:gap-10 mb-8 sm:mb-12">
            <div className="lg:col-span-2">
              <Link href="/">
                <Image src="/lg2.png" alt="FalconConnect Logo" width={150} height={60} className="h-20 sm:h-38 md:h-60 mb-4 sm:mb-6 object-contain" />
              </Link>
              <p className="text-gray-600 text-xs sm:text-sm mb-4 sm:mb-6 leading-relaxed">
                FalconConnect is a next-generation Value-Added Services (VAS) platform built for businesses and developers who need reliable, fast, and scalable messaging and payment solutions.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3 text-gray-600 text-xs sm:text-sm">
                {["About Us", "Our Team", "Careers", "News & Blog"].map((item, index) => (
                  <li key={index}>
                    <Link href={`/${item.replace(/\s+/g, '')}`} className="hover:text-black transition-all duration-200 hover:pl-2 block py-1">
                      {item}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3 text-gray-600 text-xs sm:text-sm">
                {["Bulk SMS", "USSD", "Email Campaigns", "FalconPay", "Developer APIs"].map((item, index) => (
                  <li key={index}>
                    <Link href="/solution" className="hover:text-black transition-all duration-200 hover:pl-2 block py-1">
                      {item}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3 text-gray-600 text-xs sm:text-sm">
                {["Help Center", "Documentation", "Contact Us", "FAQs"].map((item, index) => (
                  <li key={index}>
                    <Link href="/resource" className="hover:text-black transition-all duration-200 hover:pl-2 block py-1">
                      {item}
                    </Link>
                  </li>
                ))}
          ...
          <div className="border-t border-gray-300 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
            <p className="text-gray-600 text-xs sm:text-sm text-center sm:text-left">
              © 2025 FalconConnect. All Rights Reserved.
            </p>
            <div className="flex gap-4 sm:gap-6 text-gray-600 text-xs sm:text-sm">
              {["Privacy Policy", "Terms of Service", "Cookie Policy"].map((item, index) => (
                <Link key={index} href={`/${item.replace(/\s+/g, '')}`} className="hover:text-black transition-colors">
                  {item}
                </Link>
              ))}
            </div>
